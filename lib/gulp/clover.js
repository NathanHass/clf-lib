...
var browserSync = ( isDevelopment ) ? require('browser-sync').create('clover-server') : null;
 ...
 */
gulp.task('clover-html', ['clover-styles', 'clover-scripts', 'clover-bundle'], function(cb) {
 ...
 */
gulp.task('clover-styles', ['clover-modernizr'], function() {
 ...
 */
gulp.task('clover-images', function() {
 ...
 */
gulp.task('clover-fonts', function() {
 ...
 */
gulp.task('clover-bundle', function() {
 ...
 */
gulp.task('clover-scripts', ['clover-modernizr'], function() {
 ...
 */
gulp.task('clover-modernizr', function() {
  return gulp.src([
    'src/static/js/**/*.js',
 ...
 */
gulp.task('clover-bower', function() {
 ...
 */
gulp.task('clover-clean', function() {
  return del(['dist']);
});
...
if ( isDevelopment ) {
   ...
   */
  gulp.task('clover-serve', ['clover-build'], function() {
    ...
    gulp.watch([
      ...
      'data/**/*.json',
      'markdown/**/*.md',
      ], ['clover-html', browserSync.reload]);
    ...
    gulp.watch('src/static/scss/**/*.scss', ['clover-styles']);

    // Move static images and fonts to the `dist` directory and reload when source
    // files change
    gulp.watch('src/static/img/**/*', ['clover-images', browserSync.reload]);
    gulp.watch('src/static/fonts/**/*', ['clover-fonts', browserSync.reload]);
  });
...
// Clover build process, required before `clover-serve`

gulp.task('clover-build', function (cb) {
  return runSequence('clover-clean', ['clover-images', 'clover-fonts', 'clover-bower'], 'clover-html', cb);
});
